...
<body>
				...
				<nav class="navbar navbar-static-top" role="navigation"
					...
					<div class="navbar-header">
						<a class="navbar-minimalize minimalize-styl-2 btn btn-primary "
							href="${pageContext.request.contextPath}/admin/teacherslist.jsp#"><i
	...
	<script type="text/javascript">
		$(function() {
			$.post('${pageContext.request.contextPath}/teacher/teacherList',function(json){
				$("#table_list_2").jqGrid({
					data : json.teachers,
					datatype : "local",
					height : 'auto',
					...
					rowNum : 10,
					rowList : [ 10, 20, 30 ],
					colNames : [ '教师编号', '教师姓名', '账户名', '性别', '专业', '所属学院', '电话','邮箱' ],
					colModel : [ {
						name : 'teacherID',
						index : 'teacherID',
						editable : true,
						...
						name : 'teacherDepatment',
						index : 'teacherDepatment',
						editable : true,
						width : 80,
						align : "right",
						sorttype : "varchar"
